...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printHeaders(HttpServletRequest request) {
        ...
        // getHeaderNames: 옛날 방식의 헤더 정보 출력
        /*
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        System.out.println("request.getServerName() = " + request.getServerName()); //Host 헤더 호스트
        ...
        System.out.println();
        System.out.println("[Content 편의 조회]"); // POSTMAN 에서 body 에서 명시해 보내고 확인
